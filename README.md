...
- Бот: [@Equilibrium_Club_bot](https://t.me/Equilibrium_Club_bot)
- Команда `/app` открывает мини-приложение с визуализацией структуры (`admin_panel/structure_v2`).
...
# Опционально: TELEGRAM_SUPPORT_CHAT=https://t.me/your_support_chat
```
...
Для деплоя на Railway добавьте отдельный сервис/worker, который выполняет команду `python manage.py run_telegram_bot`.
