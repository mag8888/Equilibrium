...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-18&v@(xldmv1i*duu3ao@9ne3r$th@h33tdxba1oru!*o=-vyc')
...
# Caching configuration for sessions
CACHES = {
    'default': {
...
# Отключаем CSRF для API (для демо-режима)
CSRF_TRUSTED_ORIGINS = [
    "https://equilibrium.up.railway.app",
    "http://localhost:8000",
    "http://127.0.0.1:8000",
...
# RELOAD CACHE BUSTER - ИСПРАВЛЕНИЯ API v64: 1761637000
