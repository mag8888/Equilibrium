...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,web-production-48c0.up.railway.app,*.railway.app,*.up.railway.app', cast=lambda v: [s.strip() for s in v.split(',')])
...
# Custom user model (commented out for testing)
...
# Django REST Framework (simplified for testing)
REST_FRAMEWORK = {
